declare global {
    type RoomVisualStructure = STRUCTURE_CONTAINER | STRUCTURE_EXTENSION | STRUCTURE_LAB | STRUCTURE_LINK | STRUCTURE_ROAD | STRUCTURE_RAMPART | STRUCTURE_SPAWN | STRUCTURE_STORAGE | STRUCTURE_TERMINAL | STRUCTURE_TOWER | STRUCTURE_WALL | STRUCTURE_NUKER | STRUCTURE_OBSERVER | STRUCTURE_POWER_SPAWN

    interface Layout {
        room: Room
        x: number
        y: number
        type: RoomVisualStructure
        opts?: {
            opacity?: number
        }
    }
    ...
    interface RoomVisual {
        structure: (pos: RoomPosition, structure: RoomVisualStructure) => void
    }
}

// maps letters in the layout arrays to structures and vice versa
export const STRUCTURE_KEY = {
    A: STRUCTURE_SPAWN,
    N: STRUCTURE_NUKER,
    K: STRUCTURE_LINK,
    L: STRUCTURE_LAB,
...
if (!RoomVisual.prototype.structure) {
    RoomVisual.prototype.structure = function (pos: RoomPosition, structure: RoomVisualStructure): void {
        return visual_structure(pos, structure)
    }
}

export default function visual_structure(pos: RoomPosition, structure: RoomVisualStructure): void {
    const colors = {
        dark: "#181818",
        gray: "#555555",
        light: "#AAAAAA",
